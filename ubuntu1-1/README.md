...
Home Manager automatically generates a machine-specific configuration file:

**File:** `home-manager/user-config.nix`

- Auto-generated by `make gen-user-config`
- Contains your username, home directory, and system info
- Git-ignored (machine-specific, not committed)
...
**Why:** This allows the same configuration to work for any user (ubuntu, tagpro, etc.) without modifying version-controlled files.

**Note:** Do not edit this file manually - changes will be overwritten.
